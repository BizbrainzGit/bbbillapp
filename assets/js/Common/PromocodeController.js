...
            $.ajax({
                type  : 'GET',
                url   : url+"PromocodeController/SearchPromocodesList",
                async : true,
                dataType : 'json',
...
/* ======  citymapping  Table  edit  start ===== */
 ...
 $.ajax({
    type: "GET",
    url:url+'PromocodeController/editPromocodeByid/'+id,
    dataType: 'json',
...
$("#edit_promocode").validate({
 ...
 $("#updatepromocode").click(function(){
   ...
   $.ajax({
       type:"POST",
       url:url+"PromocodeController/updatePromocodeByid",
    dataType: 'json',
    data:formData,
    contentType: false, 
    cache: false,      
...
$("#addpromocode").click(function() {
   ...
   var formData = new FormData($("#add_promocode")[0] );
     $.ajax({
      type:"POST",
    url:url+"PromocodeController/savePromocode",
    dataType: 'json',
    data:formData,
    contentType: false, 
    cache: false,      
...
$(document).on('click', '.promocode_delete a', function(e){
 ...
 var name=$(this).attr("data-promocodename");
    ...
    $.ajax({
    type: "GET",
    url:url+'PromocodeController/deletePromocodeByid/'+id,
    dataType: 'json',
  beforeSend:function(){
         return confirm("Are you sure? You Delete "+name+"");
      },
  success:function(result){
      if(result.success===true)
      { 
