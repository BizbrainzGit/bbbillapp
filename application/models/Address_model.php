...
class Address_model extends Eloquent{
    ...
    protected $fillable = ['house_no', 'street', 'sub_area', 'area', 'landmark', 'city_id', 'state_id', 'country', 'pincode', 'geocoordinates', 'latitude', 'longitude', 'created_ip', 'created_by', 'created_on', 'modified_ip', 'modified_by', 'modified_on'];

	public function addAddress($addressarray)
	{
		$createaddress=self::create($addressarray);
