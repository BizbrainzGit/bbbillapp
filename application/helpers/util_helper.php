...
function sendMultiSMS($mobileNumbers,$smstemplate){
	
	// Prepare data for POST request
	//$message = rawurlencode($smstemplate);
	$dataArray = array('user'=>'phanees','pass'=>'BBtpl@4321w', 'phone' => $mobileNumbers, 'sender' => 'BZBRNZ', 'text' => $smstemplate,'priority'=>'ndnd','stype'=>'normal');
