                ...
                <div class="card-body">
                  <h4 class="card-title">Manage Customer Seleted Packages 
                   <!--  <div style="float:right">
                      <a href="/<?php echo base_url();?>Accountant-manageBusiness">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div style="float: right;">
                        ...
                        <button  id="businessselectedpakage_excel" value="excel" style="display:none;" ><img  src="/<?php echo base_url()."assets/images/excel.png" ?>" style="cursor: pointer;"/></button>
                        <button  id="businessselectedpakage_pdf" value="pdf" style="display:none;"><img  src="/<?php echo base_url()."assets/images/pdf.png" ?>" style="cursor: pointer;"></button>
                        <button  id="businessselectedpakage_print" value="print" style="display:none;"><img  src="/<?php echo base_url()."assets/images/print.png" ?>" style="cursor: pointer;"></button>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Business Payment  Details
                          <a href="/<?php echo base_url();?>Accountant-BusinessSelectedPackages"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> 
                    </h4>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                 ...
                 <a href="/<?php echo base_url();?>Accountant-BusinessSelectedPackages"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> </h4>
                     <div class="row grid-margin">
                  </div>
                  <div class="row">
                    <div class="col-12">
