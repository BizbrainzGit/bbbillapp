...
include('Layouts/accountantLayout_Header.php');
?>
...
<div class="content-wrapper business_dealclosed-class" >
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Manage Deals Closed List </h4>
                      ...
                      <div class="row clearfix" >
                               <div class="col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control"  placeholder="Search By Comany Name" name="search_businessdealclosed_cname" id="search_businessdealclosed_cname">
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-12">
                                    <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div style="float: right;">
                        ...
                        <button  id="excel" value="excel" style="display:none;" ><img  src="/<?php echo base_url()."assets/images/excel.png" ?>" style="cursor: pointer;"/></button>
                        <button  id="pdf" value="pdf" style="display:none;"><img  src="/<?php echo base_url()."assets/images/pdf.png" ?>" style="cursor: pointer;"></button>
                        <button  id="print" value="print" style="display:none;"><img  src="/<?php echo base_url()."assets/images/print.png" ?>" style="cursor: pointer;"></button>
                    </div>
        ...
        <div class="content-wrapper business_dealclosed_invoice-class" style="display: none">
          <div class="row">
              <div class="col-lg-12">
                 ...
                 <a href="/<?php echo base_url();?>Accountant-DealClosed">
         <div style="float:right;">
          ...
          <!-- </h4> -->
                        <div id="invoice_printdata">
                          ...
                          <div class="container-fluid mt-5 w-100">
                            <p class="text-right mb-2">Sub - Total Amount:&nbsp; &nbsp;<span id="business_dealclosed_invoice_subtotal"></span></p>
                            <p class="text-right mb-2">Discount Amount:&nbsp; &nbsp;<span id="business_dealclosed_invoice_dicount"></span></p>
                          <p class="text-right mb-2">Total Amount(With out GST): &nbsp; &nbsp;<span id="business_dealclosed_invoice_total"></span></p>
                            ...
                            <h4 class="text-right mb-5">Total : &nbsp; &nbsp;<span id="business_dealclosed_invoice_grandtotal"></span></h4>
                            <hr>
                          </div>
                        </div>
...
<?php
include('Layouts/accountantLayout_Footer.php');
?>
