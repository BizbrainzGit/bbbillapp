...
<div class="content-wrapper listbusiness-class">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      <div id="msg"></div>
                      <div style="float: right;">
                        <button  id="business_excel" value="excel" style="display:none;" ><img  src="/<?php echo base_url()."assets/images/excel.png" ?>" style="cursor: pointer;"/></button>
                        <button  id="business_pdf" value="pdf" style="display:none;"><img  src="/<?php echo base_url()."assets/images/pdf.png" ?>" style="cursor: pointer;"></button>
                        <button  id="business_print" value="print" style="display:none;"><img  src="/<?php echo base_url()."assets/images/print.png" ?>" style="cursor: pointer;"></button>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Business Details
                    <a href="/<?php echo base_url();?>Accountant-manageBusiness"> <div style="float:right;"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a>
                  </h4>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                 ...
                 <a href="/<?php echo base_url();?>Accountant-manageBusiness"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> </h4>
                  ...
                  <form id="edit_businessdata"  method="post" enctype="multipart/form-data" >
                    <div>
                      ...
                      <section>
                        ...
                        <div class="col-sm-6 col-12 form-group">
                          <label>City</label>
                           <select class="form-control" name="edit_business_city" id="edit_business_city" onchange="getState(this);">
                    ...
                    <!--   <h3>Map Location</h3>
                      <section>
                        <h3>Map Location</h3>
                        <div class="form-group">
                          <label>Select Company Location in Map </label>
                           <div class="map-container">
