											    ...
											    <div class="row">
										            <div class="col-12 grid-margin">
										              <div class="card">
										                <div class="card-body">
										                 <div class="d-flex flex-wrap justify-content-between">
																	<h4 class="card-title mb-3">Sales Details </h4>
																	
																	<button class="btn btn-warning btn-outline-secondary btn-sm btn-icon-text d-flex align-items-center"><i class="mdi mdi-calendar mr-1"></i><span id="alltotalsalesemployeewise_monthname"></span></button>
																	...
																	<div class="dropdown dropleft card-menu-dropdown">
																		...
																		<div class="dropdown-menu" aria-labelledby="cardMenuButtonsalestop" x-placement="left-start">
																			 <a class="dropdown-item" href="#" onClick="AllSalesEmployeewiseData(1);" ><?php echo date('M Y', strtotime('0 month')); ?></a>
																		  <a class="dropdown-item" href="#" onClick="AllSalesEmployeewiseData(2);" ><?php echo date('M Y', strtotime('-1 month')); ?></a>
																		  <a class="dropdown-item" onClick="AllSalesEmployeewiseData(3);" href="#"><?php echo date('M Y', strtotime('-2 month')); ?></a>
																		  <a class="dropdown-item"  href="#" onClick="AllSalesEmployeewiseData(4);"><?php echo date('M Y', strtotime('-3 month')); ?></a>
										                  ...
										                  <div class="row">
										                    <div class="col-12">
										                      ...
										                      <div class="table-responsive">
										                        <table id="employeesalereporttable" class="table table-hover businesstable">
										                        </table>
										                      </div>
										                    </div>
