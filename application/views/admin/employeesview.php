                                    ...
                                    <div class="form-group">
                                      <h4 id="activestatusmsg"></h4>
                                        ...
                                        <input type="hidden" id="employees_status_change" name="employees_status_change">
                                         <!--  <select class='form-control' name="employees_status_change" id="employees_status_change">
...
<div class="content-wrapper listemployees-class" id="">
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Employees List  <div style="float:right"><button type="button" class="btn btn-info btn-sm" id="showaddemployees"><i class="fa fa-plus" aria-hidden="true"></i>Add</button></div></h4>
                      ...
                      <div class="row clearfix" >
                               <div class="col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control"  placeholder="Enter Employee Name" name="search_employee_name" id="search_employee_name">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="search_employee_city" id="search_employee_city" style="width: 100%;" onchange="getState(this);">
                                       </select>
                                    </div>
                                </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                       <div id="employeesexport_msg"></div>
                      <div style="float: right;">
                        <button  id="employees_excel" value="excel" style="display:none;" ><img  src="/<?php echo base_url()."assets/images/excel.png" ?>" style="cursor: pointer;"/></button>
                        <button  id="employees_pdf" value="pdf" style="display:none;"><img  src="/<?php echo base_url()."assets/images/pdf.png" ?>" style="cursor: pointer;"></button>
                        <button  id="employees_print" value="print" style="display:none;"><img  src="/<?php echo base_url()."assets/images/print.png" ?>" style="cursor: pointer;"></button>
                    </div>
        ...
        <div class="content-wrapper addemployees-class" style="display: none;" >
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Employees Details
                 <a href="/<?php echo base_url();?>admin-manageEmployees"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> </h4>
                  ...
                  <form id="add_employeesdata"  method="post" enctype="multipart/form-data" >
                    <div>
                      ...
                      <div class="row clearfixed">
                        ...
                        <div class="col-sm-6 col-12 form-group">
                         ...
                         <div class="col-sm-6 col-12 form-group">
                          ...
                          <input type="text" class="form-control" maxlength="12" placeholder="Aadhar Number" name="add_employees_aadharno" id="add_employees_aadharno">
                        </div>
                      ...
                      <!--   <div class="col-sm-6 col-12 form-group">
                          <label>Status</label>
                          <select class="form-control" name="add_employees_status" id="add_employees_status">
                      ...
                      <section>
                        ...
                        <div class="col-sm-6 col-12 form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Sub Area" name="add_employees_subarea" id="add_employees_subarea">
                        </div>
                        <div class="col-sm-6 col-12 form-group">
                          <label>Area</label>
                  ...
                  <form id="edit_employeesdata"  method="post" enctype="multipart/form-data" >
                    <div>
                      ...
                      <div class="row clearfixed">
                        ...
                        <!--  <div class="col-sm-6 col-12 form-group">
                          <label>Employe ID</label>
                          <input type="text" class="form-control" placeholder="Employe ID" name="edit_employees_employe_id" id="edit_employees_employe_id">
                        </div> -->
                        ...
                        <div class="col-sm-6 col-12 form-group">
                          <label>Aadhar Number</label>
                          <input type="text" class="form-control" maxlength="12" placeholder="Aadhar Number" name="edit_employees_aadharno" id="edit_employees_aadharno">
                        </div>

                        <!-- <div class="col-sm-6 col-12 form-group">
                          <label>Email </label>
                          <input type="email" class="form-control" placeholder="Email" name="edit_employees_email" id="edit_employees_email">
                        </div>
                        
                        <div class="col-sm-6 col-12 form-group">
                          <label>Password</label>
                          <input type="password" class="form-control" placeholder="Password" name="edit_employees_password" id="edit_employees_password">
                        </div>    
                        
                         <div class="col-sm-6 col-12 form-group">
                          <label>Confirmed Password</label>
                          <input type="password" class="form-control" placeholder="Password" name="edit_employees_cpassword" id="edit_employees_cpassword">
                        </div>  -->
                         ...
                         <!-- <div class="col-sm-6 col-12 form-group">
                          <label>Status</label>
                          <select class="form-control" name="edit_employees_status" id="edit_employees_status">
                             <option>Select Status</option>
                             <option value="1">Active</option>
                             <option value="0">In-Active</option> 
                          </select>
                      ...
                      <section>
                        ...
                        <div class="col-sm-6 col-12 form-group">
                          <label>Sub Area</label>
                          <input type="text" class="form-control" placeholder="Sub Area" name="edit_employees_subarea" id="edit_employees_subarea">
                        </div>
                        <div class="col-sm-6 col-12 form-group">
                          <label>Area</label>
                        ...
                        <div class="col-sm-6 col-12 form-group">
                          <label>City</label>
                           <select class="form-control" name="edit_employees_city" id="edit_employees_city" onchange="getState(this);">
                        ...
                        <div class="col-sm-6 col-12 form-group">
                          <label>State</label>
                          <select class="form-control" name="edit_employees_state" id="edit_employees_state">
