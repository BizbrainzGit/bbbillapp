                    ...
                    <div class="body">
                        <form id="add_assignment" method="post" >
                            <div class="row clearfix">
                                <input type="hidden" name="add_business_id" id="add_business_id">
                               <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Select Marketing Person:</label>
                                        <select class="form-control" name="add_assignment_markrting_user" id="add_assignment_markrting_user">
                                       </select>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                   <div class="form-group">
                                      <label>Appointment Time :</label> 
                                       <select  class="form-control" name="add_appointment_time" id="add_appointment_time" >
                                     ...
                                     <!--  <input type="time" class="form-control" placeholder="Appointment Time" name="add_appointment_time" id="add_appointment_time"> -->
                                   </div>
                                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Business Details
                    <a href="/<?php echo base_url();?>Tele-Market-manageBusiness"> <div style="float:right;"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a>
                  </h4>
                  <form id="add_businessdata" name="add_businessdata" method="post" enctype="multipart/form-data" >
                    <div>
                            ...
                            <div class="col-sm-6 col-12 form-group">
                              <label> Business Status </label>
                                <!-- <select class="form-control"  name="add_business_status" id="add_business_status" >
                                 ...
                                 <select class="form-control"  name="add_business_status_telemarketing" id="add_business_status_telemarketing" >
                               </select>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                 ...
                 <a href="/<?php echo base_url();?>Tele-Market-manageBusiness"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> </h4>
