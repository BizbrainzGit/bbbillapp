...
<div class="container-scroller">
        ...
        <div class="text-left navbar-brand-wrapper d-flex align-items-center justify-content-between">
          <a class="navbar-brand brand-logo" href="/<?php echo base_url();?>Managing-Director-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.png" style="height:45px;" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="/<?php echo base_url();?>Managing-Director-Dashboard"><img src="/<?php echo base_url();?>assets/images/logo.png" height="40" alt="logo"/></a> 
    ...
    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#changepswdModal"> <i class="mdi mdi-settings text-primary"></i>Change Password</a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Managing-Director-Dashboard">
