...
<!-- Required meta tags -->
    ...
    <meta http-equiv="Expires" content="-1" />
		<title>Bill-App Marketing</title>
		<!-- base:css -->
...
<div class="container-scroller">
        ...
        <div class="text-left navbar-brand-wrapper d-flex align-items-center justify-content-between">
          <a class="navbar-brand brand-logo" href="/<?php echo base_url();?>Marketing"><img src="/<?php echo base_url();?>assets/images/logo.png" style="height:45px;" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="/<?php echo base_url();?>Marketing"><img src="/<?php echo base_url();?>assets/images/logo.png" height="40" alt="logo"/></a> 
	...
	<!-- <a class="dropdown-toggle btn btn-outline-secondary btn-fw"  href="#" data-toggle="dropdown" id="pagesDropdown"></a> -->         
               ...
               <!--  <select class="form-control form-control-lg" id="marketing_selected_city" name="marketing_selected_city" >
                    ...
                    {
                      $selected = $citydata[$i]['cityid']== $city_id ? "selected ='selected'" :'';
                      $option="<option value=".$citydata[$i]['cityid']." ".$selected." >".$citydata[$i]['cityname']."</option>";
                        echo $option ;
                    } ?>
                  </select>
	</li>
  <li class="nav-item  dropdown d-none align-items-center d-lg-flex d-none">
    <button type="button" class="btn btn-block btn-primary" id="marketing_selectedcity_btn" name="marketing_selectedcity_btn">City Change</button>
  </li> -->
          <!--   <li class="nav-item dropdown align-items-center d-lg-flex d-none">
              ...
              <span class="nav-profile-name">Today Appointments </span>
              </a>
    ...
    <a href="#" class="dropdown-item" data-toggle="modal" data-target="#changepswdModal"> <i class="mdi mdi-settings text-primary"></i>Change Password</a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Marketing-GForm-View">
           ...
           <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Marketing-Packages-List">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Marketing-User-todayAppointments">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Marketing-User-Assignments">
            <i class="mdi mdi-assistant menu-icon"></i>
            <span class="menu-title">Manage Assignments</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/<?php echo base_url();?>Marketing-manageBusiness">
            <i class="mdi mdi-hand-pointing-right menu-icon"></i>
      ...
      <div class="modal-content">
             ...
             <!--     <div class="row clearfix" id="market_appointment_statuschecked"></div> -->
                    <div class="body">
                      <div id="citymapping-editmsg"></div>
                        <form id="market_change_status_form" method="post" >
                          <input type="hidden" id="market_change_status_id" name="market_change_status_id"> 
                          <input type="hidden" id="market_change_assignment_id" name="market_change_assignment_id">
                            <div class="row clearfix">
                               <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                      <label  id="market_change_status_companyname" ></label> 
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="form-group">
                                      <label id="market_change_status_conactname" ></label> 
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                      <label id="market_change_status_mobileno"></label> 
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                      <label id="market_change_status_apptime"></label> 
                                    </div>
                                </div>

                                 <div class="col-sm-6">
                                    <div class="form-group">
                                      <label>Tele Marketing MSG:</label> 
                                    </div>
                                </div>

                                 <div class="col-sm-6">
                                    <div class="form-group">
                                      <label id="market_change_status_appmsg" ></label> 
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                      <label>Message <span style="color: red">*</span> :</label>
                                         <input  class='form-control' type="text" id="market_change_assignment_message" name="market_change_assignment_message"> 
                                    </div>
                                </div>
                                  <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Status<span style="color: red">*</span> :</label>
                                          <select class='form-control' name="market_change_status" id="market_change_status">
        ...
        <div class="modal-footer">
                           <div class="col-sm-12" style="text-align: center;">
                                  <button type="button" id="market_updatestatus" class="btn btn-primary">Update</button>
