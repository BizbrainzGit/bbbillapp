                ...
                <div class="card-body">
                  <h4 class="card-title">Manage Customer Seleted Packages 
                   <!--  <div style="float:right">
                      <a href="/<?php echo base_url();?>Marketing-BusinessSelectedPackages">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Business Payment  Details
                          <a href="/<?php echo base_url();?>Marketing-BusinessSelectedPackages"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> 
                    </h4>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                 ...
                 <a href="/<?php echo base_url();?>Marketing-BusinessSelectedPackages"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> </h4>
                     <div class="row grid-margin">
                  </div>
                  <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <div class="header">
                            ...
                            <form id="export_receipt" method="post">
                              ...
                              <div>
                               <a href="/<?php echo base_url();?>Marketing-manageBusiness">
