              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Business Details
                    <a href="/<?php echo base_url();?>Market-Lead-manageBusiness"> <div style="float:right;"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a>
                  </h4>
            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                 ...
                 <a href="/<?php echo base_url();?>Market-Lead-manageBusiness"> <div style="float:right"><button type="button" class="btn btn-info btn-sm"> Back </button></div></a> </h4>
