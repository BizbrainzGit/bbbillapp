...
class PromocodeController extends CommonBaseController {
 ...
 public function promocodeViewForAdmin(){
          $this->load->view('admin/promocodeview');
      }

public function promocodeViewForMarketingLead(){
          $this->load->view('market-lead/promocodeview');
      }
