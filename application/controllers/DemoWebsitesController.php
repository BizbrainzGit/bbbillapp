...
class DemoWebsitesController extends CommonBaseController {
  ...
  public function demowebsitesViewForAdmin()
		{
          $this->load->view('admin/demowebsitesview');
        }

 public function demowebsitesViewForITDerparment()
		{
          $this->load->view('itdepartment/demowebsitesview');
        }
