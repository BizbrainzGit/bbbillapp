...
define('FILE_TYPE_ERR','Uploaded File is not an video!!!');
define('IMAGE_NOT_UPLOADED','Photo Not Uploaded, Please Try Again ...!');
define('IMAGE_TYPE_ERR', 'Sorry, only jpg,png,jpeg,gif,PNG,JPG and JPEG files are allowed!!!');
define('FILE_SIZE_ERR','Max File Size Reached');
...
define('NOT_AVAILABLE_DATA','Your Searching Record are Not Available ...');
define('EMAIL_EXISTS_MSG', 'Email Name already exists');
define('EMPID_EXISTS_MSG', 'Employee ID already exists');
define('MAILSEND_SUCCESS_MSG','File Successfully Send To Your Email ...');
define('MAILSEND_FAIL_MSG', 'File Fail Send To Your Email ,Pls Try Again ...');

define('DWNLOAD_MSG', 'File Downloaded Successfully ...');
//Constant variables regarding Roles


define('MARKET_LEAD', 'Marketing-Lead');
define('MARKET_EXEC', 'Marketing');
define('TELE_MARKET', 'Tele-Marketing'); 
define('BB_INVOICE_NO', 'BB/20-21/'); 